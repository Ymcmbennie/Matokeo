        ...
        <div className="content">
                ...
                <CardHeader>
                  <Row>
                    <Col className="text-left" sm="6">
                      <h5 className="card-category">Maendeleo Kitaifa</h5>
                      <CardTitle tag="h2">Wastani wa taifa</CardTitle>
                    </Col>
                    <Col sm="6">
                      <ButtonGroup
          ...
          <Row>
            <Col lg="4">
              <Card className="card-chart">
                <CardHeader>
                  <h5 className="card-category">Wastanii wa form 4</h5>
                  <CardTitle tag="h3">
            ...
            <Col lg="4">
              <Card className="card-chart">
                <CardHeader>
                  <h5 className="card-category">Wastani wa form 4</h5>
                  <CardTitle tag="h3">
            ...
            <Col lg="4">
              <Card className="card-chart">
                <CardHeader>
                  <h5 className="card-category">Ufaulu la Saba</h5>
                  <CardTitle tag="h3">
                    <i className="tim-icons icon-send text-success" /> Idadi
                  </CardTitle>
                </CardHeader>
                <CardBody>
                  <div className="chart-area">
